...
%\end{itemize}
%------------------------------------------------
%\bibitem[OpenBRR.org, 2005]{OpenBRR.org:2005dg}
%OpenBRR.org. (2005).
%\newblock Business Readiness Rating for Open Source: A Proposed Open Standard to Facilitate Assessment and Adoption of Open Source Software.
%\newblock BRR 2005 - RFC 1.
%-----------------------------------------------
